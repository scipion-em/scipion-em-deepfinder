...
from deepfinder.viewers.deprecated.particle_annotator_tomo_viewer import ParticleAnnotatorDialog
from deepfinder.viewers.deprecated.particle_annotator_tree import ParticleAnnotatorProvider
